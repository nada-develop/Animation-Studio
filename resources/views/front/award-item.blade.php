        ...
        <div class="container">
           <div class="row">
               <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                 <h2 class="title-h2">{{ $award_item->title }}</h2>
                 <nav aria-label="breadcrumb">
                   <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="/">Home</a></li>
                     <li class="breadcrumb-item"><a href="/award">Award</a></li>
                     <li class="breadcrumb-item active" aria-current="page">{{ $award_item->title }}</li>
                   </ol>
                 </nav>
               </div>
             </div>
              ...
              <div class="col-xl-9 col-md-12 col-sm-12 col-12">
                ...
                <div class="post-info">
                    <div class="post-info-item">
                        <a class="post-info__link" href=""><i class="zmdi zmdi-account-o"></i>{{ $award_item->title }}</a>
                        <span class="post-info__text"><i class="zmdi zmdi-calendar"></i>Oct 12, 2019{{ $award_item->date }}</span>
                ...
                <div class="box-post">
                    <h1 class="title-post">{{ $award_item->title }}</h1>
                    <p class="post-description">{{ $award_item->description }}</p>
                </div>
                ...
                <div class="box-author">
                    ...
                    <div class="box-author-item">
                        <p class="box-author__name">{{ $award_item->title }}</p>
                        ...
                        <a href="/award" class="btn-text btn-text-img">View all Awards</a>
                    </div>
                </div>
