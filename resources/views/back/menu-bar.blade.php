<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="/admin/pages" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="blog" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="/admin/blog/create"> New Post  </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="portfolio" data-parent="#accordionExample">
                    <li>
                        <a href="/admin/portfolio"> Portfolio Item </a>
                    </li>
                    <li>
                        <a href="/admin/portfolio/create"> New Portfolio  </a>
                    </li>
                </ul>
            </li>

            <li class="menu">
                <a href="#award" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" id="award" data-parent="#accordionExample">
                    <li>
                        <a href="/admin/award"> Awards List </a>
                    </li>
                    <li>
                        <a href="/admin/award/create"> New Award  </a>
                    </li>
                </ul>
            </li>
